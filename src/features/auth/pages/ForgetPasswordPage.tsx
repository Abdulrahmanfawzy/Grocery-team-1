      ...
      <div className="flex min-h-[610px] items-center justify-center">
        <form className="w-full px-4 lg:px-50 text-center">
          <div className="lg:text-center mb-12 ">
            ...
            <p className="mt-1 text-xs px-10">Enter your Mobile Number to recover your password</p>
          </div>
          {/* Input Phone */}
          <Input id="phone" type="tel" placeholder="Enter your Number" Icon={<Phone size={19} />} />
